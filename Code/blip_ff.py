...
from blip_transform import get_blip_transform
...
class BLIPFeatureFusion(nn.Module):
    ...
    def encode_multimodal_input(self, txt_dict_batched, image_batched, txt_mask=None, img_mask=None, use_momentum=False):
