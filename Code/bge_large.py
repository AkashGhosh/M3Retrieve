...
class RetrievalModel(DRESModel):
    ...
    def encode_corpus(self, corpus: List[Dict[str, str]], **kwargs) -> np.ndarray:
        ...
        return self._do_encode(input_texts,max_length=768)
    ...
    for name in folders:
        class Custom_Class(AbsTaskRetrieval):
            metadata = TaskMetadata(
                ...
                model_type="nv_embed",
                dataset={
                    "path": f"/home/kitsuchart/aakash/MedRAG/clustered_dataset_extended/MMQSD_Ret",
                    "revision": "None",
                    "model_type":"e5_large",
                },
                description=(
        ...
        results_dict = evaluation.run(model=model,output_folder=f'./results_new/MMQSD_Ret/bge_large/{name}',eval_splits=["test"],overwrite_results=True,corpus_chunk_size=400000)
        ...
        print("==================================================")
        print("Finish evaluation for model:BGE")
