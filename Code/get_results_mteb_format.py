...
class RetrievalModel(DRESModel):
    ...
    def encode_queries(self, queries: List[str], **kwargs) -> np.ndarray:
        ...
        #     input_texts = [f'query:'+str(q) for q in queries]
        # else:
...
# ]
    for name in folders:
        ...
        results_dict = evaluation.run(model=model,output_folder=f'./results_new/IT2I/mm_embed/{name}',eval_splits=["test"],overwrite_results=True,corpus_chunk_size=400000)
